      ...
      {activePost && typeof window !== 'undefined' && createPortal(
        ...
        >
          ...
          >
            ...
            <div className="flex-1 px-6 pb-8 pt-8 overflow-y-auto" style={{ WebkitOverflowScrolling: 'touch' }}>
              <article>
                      ...
                      return (
                        <>
                          ...
                          <button
                            type="button"
                            onClick={() => {
                              const shareUrl = `https://wa.me/?text=${encodeURIComponent(activePost.fields.title + ' - ' + url)}`;
                              window.open(shareUrl, '_blank', 'noopener,noreferrer');
                            }}
